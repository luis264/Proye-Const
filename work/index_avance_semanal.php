...
<html>
	<head>
		<title>DATOS AVANCE SEMANAL</title>
	...
	<body>
		<div class="container">
			...
			<h3 align="center">ADMINISTRADOR AVANCE SEMANAL</h3>
			<br />
		...
		<div class="modal-content">
			<form method="post" id="api_crud_form">
				<div class="modal-header">
		        	...
		        	<h4 class="modal-title">Datos AVANCE</h4>
		      	</div>
