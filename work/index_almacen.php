...
<html>
	<head>
		<title>DATOS PERMISO ALMACEN</title>
	...
	<body>
		<div class="container">
			...
			<h3 align="center">ADMINISTRADOR DATOS ALMACEN</h3>
			<br />
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').text('DATOS ALMACEN');
	...
	$('#api_crud_form').on('submit', function(event){
		...
		else if($('#id_material').val() == '')
		{
			alert("Ingrese id material");
		}
		else
		{
			var form_data = $(this).serialize();
			$.ajax({
				url:"action_almacen.php",
				method:"POST",
				data:form_data,
				success:function(data)
				{
